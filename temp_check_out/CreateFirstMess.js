(() => {
  ...
  // frontend/src/pages/CreateFirstMess.jsx
  var CreateFirstMessPage = () => {
    const navigate = (0, import_react_router_dom2.useNavigate)();
    return /* @__PURE__ */ import_react2.default.createElement("div", { className: "min-h-screen bg-gradient-to-br from-blue-50 via-indigo-100 to-purple-50" }, /* @__PURE__ */ import_react2.default.createElement(MessDashboardNavbar_default, null), /* @__PURE__ */ import_react2.default.createElement("div", { className: "pt-24 px-4 sm:px-6" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "max-w-3xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-lg p-8 text-center" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "w-16 h-16 mx-auto rounded-full bg-indigo-100 text-indigo-700 flex items-center justify-center mb-4" }, /* @__PURE__ */ import_react2.default.createElement(import_lucide_react2.Store, { className: "w-8 h-8" })), /* @__PURE__ */ import_react2.default.createElement("h1", { className: "text-3xl font-bold text-slate-800 mb-3" }, "Create your first mess"), /* @__PURE__ */ import_react2.default.createElement("p", { className: "text-slate-600 mb-8" }, "You do not have any registered mess yet. Start by adding your first mess and then manage menu, members, and attendance from one place."), /* @__PURE__ */ import_react2.default.createElement(
      "button",
      {
        type: "button",
      ...
      /* @__PURE__ */ import_react2.default.createElement(import_lucide_react2.PlusCircle, { className: "w-5 h-5" }),
      "Add Your First Mess"
    ))));
  };
  var CreateFirstMess_default = CreateFirstMessPage;
})();
